...
class App extends Component {
  ...
  render() {
    let chatBoxClasses = this.state.showChatBox
      ? ''
      : 'd-none d-sm-none d-md-block';

    let chatListClasses = this.state.showChatList
      ? ''
      : 'd-none d-sm-none d-md-block';
      ...
      <div>
        ...
        <Container>
          <Row className="show-grid">
            <Col xs={12} sm={12} md={4} className={chatListClasses}>
              <UserList
                userData={this.state.userChatData}
                onChatClicked={this.onChatClicked.bind(this)}
              />
            </Col>
            <Col xs={12} sm={12} md={8} className={chatBoxClasses}>
              <ChatBox
